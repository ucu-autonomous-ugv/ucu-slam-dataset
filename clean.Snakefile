...
rule clean_sequence:
    ...
    shell:
        ...
        python3 scripts/clean.py {input.raw_dir} {output.clean_dir} {params.flags} --force --face-model-path {input.face_model} --license-plate-model-path {input.license_plate_model} --calibration-file {input.calibration}
        """
